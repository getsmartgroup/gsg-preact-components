...
var ColoredProduct = function () {
    ...
    return (preact_1.h(react_1.Box, { w: 'full', position: 'relative' }, images.filter(function (e) { return e; }).map(function (e) { return (preact_1.h("img", { src: e, class: "gsg-procuts-hot-tub" })); })));
};
